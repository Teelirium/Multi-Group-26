...
res = open('IO-bound. Проверяем ссылки на страницах Википедии/res.txt', 'w', encoding='utf8')
...
links = open('IO-bound. Проверяем ссылки на страницах Википедии/res.txt', encoding='utf8').read().split('\n')
